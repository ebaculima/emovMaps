                        ...
                        l = function (e) {
                            this.initialize = function () {
                                ...
                                angular.forEach(r, function (e, n) {
                                    ...
                                    f = s.isInt(p) && 4326 != p ? d.readFeature(c, {dataProjection: "EPSG:" + p, featureProjection: "EPSG:4326"}) : d.readFeature(c), f.anio = anio, f.label = l, f.sameAs = sa, f.idUriClass = t;
                                    var g = f.getGeometry().getType();
                                    "Point" == g && f.setStyle(a), "MultiPolygon" == g && f.setStyle(b), o.addFeature(f)
                                ...
                                n.on("pointermove", function (e) {
                                    ...
                                    if (o) {
                                        r.setPosition(t);
                                        var i = $("div.popover:visible").length > 0, a = "Long: " + t[0] + "<br/> Lat: " + t[1] + (o.anio ? "<br/> Año: " + o.anio : ""), l = o.label;
